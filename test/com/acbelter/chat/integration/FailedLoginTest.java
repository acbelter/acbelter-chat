...
public class FailedLoginTest implements MessageListener {
    ...
    public void failedLogin() throws Exception {
        clientHandler.send(new LoginMessage(RandomStringUtils.randomAscii(8), RandomStringUtils.randomAscii(8)));
        Thread.sleep(1000);
        assert resultMessage.getType() == CommandType.COMMAND_RESULT;
        CommandResultMessage msg = (CommandResultMessage) resultMessage;
        assert msg.getState() == CommandResultState.FAILED;
    }
